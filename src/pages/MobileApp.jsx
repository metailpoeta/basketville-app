...
export default function MobileApp() {
  ...
  const [threePtPlayoffTab, setThreePtPlayoffTab] = useState('semifinali'); // 🎯 AGGIORNATO: Rimosso 'batterie', si parte da 'semifinali'
...
useEffect(() => {
        ...
        return (
          <div className="animate-in fade-in duration-300 flex flex-col h-full">
            ...
            <div className="flex flex-col gap-3 pb-6">
              {dayMatches.length === 0 ? (
                 <div className="text-center py-10 bg-neutral-900/50 border border-neutral-800 rounded-2xl text-neutral-500 uppercase font-bold tracking-widest text-[15px]">
          ...
          <div className="animate-in fade-in duration-300 flex flex-col h-full">
            ...
            <div className="flex bg-neutral-900/80 border border-neutral-800 rounded-xl p-1 mb-2 shadow-inner">
              <button
                ...
                className={`appearance-none outline-none focus:outline-none focus:ring-0 active:outline-none [-webkit-tap-highlight-color:transparent] flex-1 py-2.5 text-[15px] font-black uppercase tracking-widest rounded-lg transition-all border ${
                  veroCupTab === 'gironi' 
            ...
            {veroCupTab === 'gironi' && (
              <div className="flex flex-col pb-6">
                {groupNames.length === 0 ? (
                  <p className="text-center text-neutral-500 text-[15px] font-bold uppercase tracking-widest mt-4 bg-neutral-900/50 py-8 rounded-2xl border border-neutral-800">Nessun girone disponibile</p>
                ) : (
                  <>
                      ...
                      <div className="flex gap-2 overflow-x-auto pb-2 mt-6 mb-6 snap-x [&::-webkit-scrollbar]:hidden">
                        {groupNames.map(g => (
                          <button
                            ...
                            className={`outline-none focus:outline-none [-webkit-tap-highlight-color:transparent] shrink-0 px-6 py-2.5 rounded-full font-black uppercase tracking-widest text-[15px] border transition-all snap-start ${
                              displayGroup === g 
                      ...
                      <div key={displayGroup} className="flex flex-col gap-5 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="bg-black/40 border border-neutral-800/80 rounded-2xl overflow-hidden shadow-sm">
                          <div className="bg-neutral-900 px-4 py-3 flex items-center justify-between">
                            <span className="font-black text-pink-500 uppercase tracking-widest text-[18px]">Classifica</span>
                          </div>
                          
                          <div className="flex text-[15px] font-bold text-neutral-500 uppercase tracking-widest px-4 py-2.5 bg-black/60">
                          ...
                          <div className="flex flex-col">
                            {groups[displayGroup].map((team, idx) => (
                              <div key={team.id} className="flex items-center px-4 py-4 even:bg-white/[0.02]">
                                <div className="w-5 shrink-0 text-[15px] font-black text-neutral-600">{idx + 1}</div>
                                <div className="flex-1 text-[18px] font-black text-white tracking-wider uppercase truncate pr-2">{team.name}</div>
                                <div className="w-8 shrink-0 text-center text-[15px] font-bold tracking-wider text-neutral-400">{team.w}</div>
                                <div className="w-8 shrink-0 text-center text-[15px] font-bold tracking-wider text-neutral-400">{team.l}</div>
                                <div className="w-8 shrink-0 text-center text-[15px] font-bold tracking-wider text-neutral-400">{team.pf}</div>
                                <div className="w-8 shrink-0 text-center text-[15px] font-bold tracking-wider text-neutral-400">{team.ps}</div>
                                <div className="w-8 shrink-0 text-center text-lg font-black tracking-wider text-pink-400 self-center leading-none">{team.pt}</div>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-2 mt-2">
                          <span className="text-[15px] font-black uppercase tracking-widest text-neutral-500 ml-1 mb-1">Risultati Girone {displayGroup}</span>
                          {groupMatches
            ...
            {veroCupTab === 'playoff' && (
              <div className="flex flex-col pb-6 animate-in fade-in slide-in-from-right-4 duration-300">
                 {playoffMatches.length === 0 ? (
                    <p className="text-center text-neutral-500 text-[15px] font-bold uppercase tracking-widest mt-4 bg-neutral-900/50 py-8 rounded-2xl border border-neutral-800">Tabellone in aggiornamento</p>
                 ) : (
                    (() => {
                        ...
                        <div className="flex flex-col gap-6">
                          ...
                          {semis.length > 0 && (
                            <div className="flex flex-col gap-3 mt-2">
                              <span className="text-[15px] font-black uppercase tracking-[0.25em] text-neutral-500 ml-1">
                                ➔ Semifinali
                              </span>
                          ...
                          {finals.length > 0 && (
                            <div className="flex flex-col gap-3">
                              <span className="text-[15px] font-black uppercase tracking-[0.25em] text-pink-500 ml-1 drop-shadow-[0_0_6px_rgba(236,72,153,0.2)]">
            ...
            {activeContestTab === '3pt' && (
              <div className="flex flex-col animate-in fade-in slide-in-from-right-4 duration-300 pb-6">
                ...
                <div className="flex gap-2 overflow-x-auto pb-2 mt-6 mb-6 snap-x [&::-webkit-scrollbar]:hidden">
                  ...
                  <button onClick={() => setThreePtTab('playoff')} className={`outline-none focus:outline-none [-webkit-tap-highlight-color:transparent] shrink-0 px-6 py-2.5 rounded-full font-black uppercase tracking-widest text-[15px] border transition-all snap-start ${threePtTab === 'playoff' ? 'bg-pink-500 text-white border-pink-400 shadow-[0_0_15px_rgba(236,72,153,0.4)]' : 'bg-neutral-900 border-neutral-800 text-neutral-500 hover:text-white'}`}>
                    FINALS
                  </button>
                </div>
                ...
                {threePtTab === 'qualificazioni' && (
                  <div className="flex flex-col gap-3">
                    {real3PtQual.length === 0 ? (
                      <div className="p-6 text-center text-[15px] border border-dashed border-neutral-800 rounded-xl text-neutral-500 uppercase tracking-widest font-bold">
                        ...
                        <div key={p.id} className="bg-gradient-to-br from-neutral-900 to-neutral-950 border border-neutral-800/80 rounded-2xl p-4 flex items-center justify-between relative overflow-hidden shadow-sm transition-transform active:scale-[0.98]">
                          ...
                          <div className="flex items-center gap-4 z-10 min-w-0">
                            ...
                            <div className="flex flex-col min-w-0 pr-2">
                              <span className="text-[18px] font-black tracking-wider text-white uppercase truncate">{p.player_name}</span>
                              {p.team && <span className="text-[15px] font-bold text-pink-500 uppercase tracking-widest truncate mt-0.5">{p.team}</span>}
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-5 z-10 shrink-0">
                            <div className="flex flex-col items-center justify-center">
                               <span className="text-[15px] font-bold text-neutral-500 uppercase tracking-widest mb-1">Tempo</span>
                               <span className="text-[15px] font-mono text-neutral-400 bg-black/60 px-2 py-0.5 rounded border border-neutral-800">{p.time}s</span>
                            </div>
                            <div className="flex flex-col items-end justify-center border-l border-neutral-800/80 pl-5">
                               <span className="text-[15px] font-black text-neutral-500 uppercase tracking-widest mb-0.5">Punti</span>
                               <span className="text-3xl font-black text-pink-400 tabular-nums leading-none drop-shadow-[0_0_8px_rgba(236,72,153,0.3)] tracking-wider">{p.score}</span>
                            </div>
                          </div>
                        </div>
                      ))
    ...
    <div className="flex bg-neutral-900/50 border border-neutral-800 rounded-lg p-1 mb-6 shadow-inner">
                      {['semifinali', 'finale'].map((fase) => (
                        <button
                          ...
                          className={`appearance-none outline-none focus:ring-0 flex-1 py-2 text-[15px] font-black uppercase tracking-widest rounded-md transition-all ${
                    ...
                    <div className="flex flex-col gap-4">
                      {real3PtPlayoff[threePtPlayoffTab]?.length === 0 ? (
                        <div className="text-center py-6 text-neutral-500 text-[15px] font-bold uppercase tracking-widest border border-dashed border-neutral-800 rounded-xl">
                            ...
                            <div key={heat.id} className={`bg-gradient-to-br from-neutral-900 to-neutral-950 border rounded-2xl p-4 flex flex-col gap-3 shadow-sm transition-transform active:scale-[0.98] ${isFinaleCard && hasPlayed ? 'border-yellow-500/30' : 'border-neutral-800/80'}`}>
                              ...
                              <div className="flex flex-col gap-3 w-full z-10">
                                {heat.players.map((p, idx) => {
                                  // 🎯 LOGICA VINCITORI MODIFICATA: Nelle semifinali i primi 3, in finale solo il 1°
                                  const isWinner = hasPlayed && (threePtPlayoffTab === 'semifinali' ? idx < 3 : idx === 0);
                                  const isChampion = isFinaleCard && isWinner && idx === 0; // È il campione se vince la finale (idx===0 garantisce sicurezza)
                                  const showGreenTime = isWinner && tieBreaker;

                                  return (
                                    <React.Fragment key={p.id || idx}>
                                      {/* Separatore */}
                                      {idx > 0 && <div className="h-px w-full bg-neutral-800/60 my-1"></div>}
                                      ...
                                      <div className="flex justify-between items-center w-full">
                                        ...
                                        <div className="flex items-center gap-2 min-w-0 flex-1 pr-4">
                                          ...
                                          <span className={`text-[18px] font-black tracking-wider uppercase truncate ${isChampion ? 'text-yellow-400' : isWinner ? 'text-white' : 'text-neutral-500'}`}>
                                            {p.player_name || 'TBD'}
                                          </span>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-end gap-4 shrink-0">
                                          <span className={`text-[15px] font-mono px-2.5 py-1 rounded border ${showGreenTime ? 'text-green-400 border-green-500/30 bg-green-500/10 shadow-[0_0_8px_rgba(34,197,94,0.3)]' : 'text-neutral-500 bg-black/60 border-neutral-800'}`}>
                                            {p.time || '0.0'}s
                                          </span>
                                          <span className={`text-3xl w-10 text-right font-black tabular-nums tracking-wider ${isChampion ? 'text-yellow-400 drop-shadow-[0_0_8px_rgba(234,179,8,0.5)]' : isWinner ? 'text-pink-400 drop-shadow-[0_0_8px_rgba(236,72,153,0.3)]' : 'text-neutral-600'}`}>
                                            {p.score || 0}
                                          </span>
                                        </div>
            ...
            {activeContestTab === 'dunk' && (
              <div className="flex flex-col animate-in fade-in slide-in-from-right-4 duration-300 pb-6">
                <div className="flex gap-2 overflow-x-auto pb-2 mt-6 mb-6 snap-x [&::-webkit-scrollbar]:hidden">
                  ...
                  <button onClick={() => setDunkTab('finale')} className={`outline-none focus:outline-none [-webkit-tap-highlight-color:transparent] shrink-0 px-6 py-2.5 rounded-full font-black uppercase tracking-widest text-[15px] border transition-all snap-start ${dunkTab === 'finale' ? 'bg-pink-500 text-white border-pink-400 shadow-[0_0_15px_rgba(236,72,153,0.4)]' : 'bg-neutral-900 border-neutral-800 text-neutral-500 hover:text-white'}`}>
                    Finale
                  </button>
                </div>

                <div className="flex flex-col gap-3">
                  {dunkTab === 'qualificazioni' && realDunkQual.length === 0 && <div className="p-6 text-center text-[15px] border border-dashed border-neutral-800 rounded-xl text-neutral-500 uppercase tracking-widest font-bold">Nessun dato disponibile</div>}
                  {dunkTab === 'finale' && realDunkFinale.length === 0 && <div className="p-6 text-center text-[15px] border border-dashed border-neutral-800 rounded-xl text-neutral-500 uppercase tracking-widest font-bold">Nessun dato disponibile</div>}
                      ...
                      <div key={dunk.id} className={`bg-gradient-to-br from-neutral-900 to-neutral-950 border rounded-2xl p-4 flex flex-col gap-3 relative overflow-hidden shadow-sm transition-transform active:scale-[0.98] ${isChampion ? 'border-yellow-500/50 shadow-[0_0_15px_rgba(234,179,8,0.2)]' : 'border-neutral-800/80'}`}>
                        ...
                        <div className="flex justify-between items-center z-10 w-full">
                          ...
                          <div className="flex items-center gap-3 flex-1 min-w-0 pr-4">
                            ...
                            {isChampion && <span className="text-3xl drop-shadow-md">👑</span>}
                            
                            <div className="flex flex-col min-w-0">
                              <div className={`text-[18px] font-black tracking-wider uppercase truncate ${isChampion ? 'text-yellow-400' : 'text-white'}`}>{dunk.name}</div>
                              {dunk.team && <div className="text-[15px] font-bold text-pink-500 uppercase tracking-widest truncate mt-0.5">{dunk.team}</div>}
                            </div>
                          </div>

                          <div className="flex flex-col items-end justify-center shrink-0 border-l border-neutral-800/80 pl-4">
                             <span className="text-[15px] font-black text-neutral-500 uppercase tracking-widest mb-0.5">Totale</span>
                             <span className={`text-4xl font-black tabular-nums tracking-wider leading-none ${isChampion ? 'text-yellow-400 drop-shadow-[0_0_8px_rgba(234,179,8,0.5)]' : 'text-pink-400 drop-shadow-[0_0_8px_rgba(236,72,153,0.3)]'}`}>{dunk.score}</span>
                          </div>
                        </div>

                        {/* DETTAGLIO SCHIACCIATE (Dunk 1 & Dunk 2) */}
                        <div className="flex gap-2 w-full z-10 mt-2">
                          <div className={`flex-1 bg-black/60 border rounded-xl p-3 flex justify-between items-center ${isChampion ? 'border-yellow-500/20' : 'border-neutral-800/80'}`}>
                            <span className="text-[15px] font-bold text-neutral-500 uppercase tracking-widest">Dunk 1</span>
                            <span className={`text-xl font-black tracking-wider tabular-nums ${isChampion ? 'text-yellow-100' : 'text-white'}`}>{dunk.dunk_1 > 0 ? dunk.dunk_1 : '-'}</span>
                          </div>
                          <div className={`flex-1 bg-black/60 border rounded-xl p-3 flex justify-between items-center ${isChampion ? 'border-yellow-500/20' : 'border-neutral-800/80'}`}>
                            <span className="text-[15px] font-bold text-neutral-500 uppercase tracking-widest">Dunk 2</span>
                            <span className={`text-xl font-black tracking-wider tabular-nums ${isChampion ? 'text-yellow-100' : 'text-white'}`}>{dunk.dunk_2 > 0 ? dunk.dunk_2 : '-'}</span>
                          </div>
                        </div>
      ...
      case 'stats': {
        ...
        return (
          <div className="animate-in fade-in duration-300 flex flex-col h-full pb-6">
            ...
            {topScorers.length === 0 ? (
               <div className="text-center py-10 text-neutral-500 font-bold uppercase tracking-widest border border-dashed border-neutral-800 rounded-xl text-[15px]">
                 Nessun dato disponibile
               </div>
            ) : (
              <div className="flex flex-col gap-4">
                ...
                {/* RE DEI BOMBER (#1) */}
                <div className="bg-gradient-to-br from-yellow-500/10 via-black/80 to-yellow-900/40 border border-yellow-500/50 rounded-3xl p-6 flex flex-col items-center relative overflow-hidden shadow-[0_0_30px_rgba(234,179,8,0.15)]">
                  <div className="absolute -top-8 text-[120px] opacity-[0.05] pointer-events-none">👑</div>
                  
                  <span className="text-5xl drop-shadow-md z-10 mb-3">👑</span>
                  <span className="text-yellow-500 font-black tracking-[0.3em] uppercase text-[15px] mb-5 drop-shadow-md">
                    Capocannoniere
                  </span>
                  
                  <div className="flex flex-col items-center text-center z-10 w-full mb-8">
                    <span className="text-3xl font-black text-white uppercase tracking-widest leading-none truncate w-full px-2">
                      {top1.last_name}
                    </span>
                    <span className="text-[15px] font-bold text-yellow-400 uppercase tracking-[0.2em] mt-2">
                      {top1.first_name}
                    </span>
                  </div>

                  <div className="bg-black/60 w-full rounded-2xl py-6 flex flex-col items-center border border-yellow-500/20 shadow-inner">
                    <span className="text-[15px] font-bold text-neutral-400 uppercase tracking-widest mb-2">Punti Totali</span>
                    <span className="text-7xl font-black text-yellow-400 tracking-wider drop-shadow-[0_0_15px_rgba(234,179,8,0.5)] leading-none tabular-nums">
                      {top1.totalPoints}
                    </span>
                    
                    <div className="mt-5 flex items-center gap-3 bg-white/5 px-5 py-2.5 rounded-full border border-yellow-500/20">
                      <span className="text-neutral-400 uppercase font-bold tracking-widest text-[15px]">Media:</span>
                      <span className="text-white font-black text-[15px] tabular-nums tracking-wider">{top1.avgPoints} <span className="text-[15px] text-neutral-500 tracking-normal">pt/gara</span></span>
                    </div>
                  </div>
                </div>

                {/* INSEGUITORI (Dal 2° al 10°) */}
                <div className="bg-neutral-900/80 border border-neutral-800 rounded-2xl p-3 shadow-sm flex flex-col gap-2 mt-2">
                  
                  {/* Intestazione Colonne */}
                  <div className="flex text-neutral-500 font-bold uppercase text-[15px] tracking-widest px-2 pb-2 border-b border-neutral-800/80">
                  ...
                  {/* Righe Giocatori */}
                  {others.map((p, i) => (
                    <div key={p.id} className="flex items-center bg-black/40 border border-neutral-800/80 rounded-xl px-3 py-3 transition-transform active:scale-[0.98]">
                      <div className="w-8 text-[18px] font-black text-neutral-600">#{i + 2}</div>
                      <div className="flex-1 flex flex-col min-w-0 pr-2">
                        <span className="text-[18px] font-black text-white tracking-wider uppercase truncate">{p.last_name}</span>
                        <span className="text-[15px] font-bold text-neutral-400 tracking-widest uppercase truncate mt-0.5">{p.first_name}</span>
                      </div>
                      <div className="w-8 text-center text-[15px] font-bold tracking-wider text-neutral-500 tabular-nums">{p.games}</div>
                      <div className="w-10 text-center text-[15px] font-black tracking-wider text-neutral-300 tabular-nums">{p.avgPoints}</div>
                      <div className="w-10 text-right text-xl font-black tracking-wider text-pink-500 tabular-nums">{p.totalPoints}</div>
                    </div>
                  ))}
      ...
      case 'others': {
        ...
        return (
          <div className="animate-in fade-in duration-300 flex flex-col h-full pb-6">
            ...
            <div className="flex flex-col gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="bg-gradient-to-br from-neutral-900 to-neutral-950 border border-neutral-800/80 rounded-2xl p-5 flex items-center justify-between transition-all active:scale-[0.98] hover:bg-neutral-900/60 cursor-pointer [-webkit-tap-highlight-color:transparent]"
                >
                  <div className="flex items-center gap-5 min-w-0">
                    
                    {/* Box Icona con colore di Brand mascherato */}
                    <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${social.brandColor} border flex items-center justify-center shrink-0 shadow-inner`}>
                      {social.name === 'Instagram' && <Instagram size={26} />}
                      {social.name === 'YouTube' && <Youtube size={26} />}
                      {social.name === 'Facebook' && <Facebook size={26} />}
                    </div>
            ...
            <div className="mt-12 text-center text-neutral-700 text-[15px] font-black uppercase tracking-[0.3em]">
  ...
  const renderPlayerRow = (p) => (
    <div key={p.id} className="flex justify-between items-center bg-neutral-900 border border-neutral-800/80 px-5 py-4 rounded-xl shadow-sm">
      <div className="flex items-center gap-4 min-w-0">
        <span className="text-pink-500 font-mono font-black w-6 text-left text-[18px]">
          #{p.jersey_number}
        </span>
        <span className="font-black tracking-wider text-white uppercase text-[18px] truncate">
          {p.players?.last_name} {p.players?.first_name?.charAt(0)}.
        </span>
      </div>
      <span className={`font-black tracking-wider tabular-nums text-xl ${p.match_points > 10 ? 'text-pink-400 drop-shadow-[0_0_8px_rgba(236,72,153,0.3)]' : 'text-neutral-300'}`}>
        {p.match_points} <span className="text-[15px] tracking-normal text-neutral-500 font-bold ml-0.5">pt</span>
      </span>
    </div>
  );
...
{/* HEADER SUPERIORE - ALLINEAMENTO MILLIMETRICO DEI TRE ASSI */}
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-3.5 h-7 flex items-center justify-center pointer-events-none">
          <span className="text-[9px] font-black uppercase tracking-[0.35em] text-neutral-600 bg-neutral-950 px-3 pointer-events-auto select-none leading-none">
            Official App
          </span>
        </div>
        ...
        <div className="flex items-center shrink-0 z-10 h-7">
          <span className="text-[9px] font-black bg-neutral-900 text-neutral-400 px-3 py-1.5 rounded-full uppercase tracking-widest border border-neutral-800 shadow-inner leading-none">
...
{/* ========================================================
          ...
          <div className="fixed inset-0 z-50 flex items-end justify-center overflow-hidden">
            ...
            >
              ...
              <div className="w-full flex items-center justify-between px-5 pt-4 pb-2 shrink-0 z-20 relative cursor-grab active:cursor-grabbing">
                ...
                <button 
                  onClick={() => setSelectedMatch(null)}
                  className="p-2.5 bg-neutral-900 border border-neutral-800 rounded-full text-neutral-400 hover:text-white active:scale-90 transition-transform shrink-0 flex items-center justify-center shadow-md pointer-events-auto"
                >
                  <X size={18} />
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto px-5 space-y-6 [&::-webkit-scrollbar]:hidden pointer-events-auto">
                ...
                <div className="text-center pt-2">
                  <span className="text-[15px] bg-pink-500/10 border border-pink-500/30 text-pink-400 px-4 py-1.5 rounded-full uppercase tracking-widest font-black inline-block mb-5">
                  ...
                  <div className="flex items-center justify-between w-full px-2 gap-3">
                    <div className="flex-1 text-center min-w-0">
                      <h3 className="text-2xl font-black uppercase tracking-wider text-white truncate break-words">{selectedMatch.team_a?.teams?.name}</h3>
                      <p className="text-[15px] font-bold text-neutral-500 uppercase tracking-widest mt-1.5 truncate">Coach: {selectedMatch.team_a?.coach || 'TBD'}</p>
                    </div>
                    
                    <div className="px-6 py-3 bg-neutral-900 border border-neutral-800 rounded-3xl text-5xl font-black tracking-wider text-white shadow-inner shrink-0 tabular-nums">
                      {selectedMatch.score_a ?? 0} <span className="text-pink-500 font-normal text-4xl mx-1.5">-</span> {selectedMatch.score_b ?? 0}
                    </div>
                    
                    <div className="flex-1 text-center min-w-0">
                      <h3 className="text-2xl font-black uppercase tracking-wider text-white truncate break-words">{selectedMatch.team_b?.teams?.name}</h3>
                      <p className="text-[15px] font-bold text-neutral-500 uppercase tracking-widest mt-1.5 truncate">Coach: {selectedMatch.team_b?.coach || 'TBD'}</p>
                    </div>
                  </div>

                  {/* MINI TABELLA DEI QUARTI */}
                  <div className="mt-6 flex justify-center gap-5 text-neutral-300 font-bold bg-neutral-900/40 border border-neutral-900 px-5 py-3.5 rounded-2xl shadow-inner">
                    {['Q1', 'Q2', 'Q3', 'Q4'].map((q, i) => (
                      <div key={q} className="flex flex-col items-center flex-1 border-r border-neutral-800/60 last:border-0 pr-1 last:pr-0">
                        <span className="text-[15px] text-neutral-500 uppercase tracking-widest font-black mb-1">{q}</span>
                        <span className="text-[15px] font-black tracking-wider tabular-nums">{selectedMatch[`q${i+1}_a`] ?? 0}-{selectedMatch[`q${i+1}_b`] ?? 0}</span>
                      </div>
                    ))}
                    {(selectedMatch.ot_a > 0 || selectedMatch.ot_b > 0) && (
                      <div className="flex flex-col items-center flex-1 text-pink-400 pl-1">
                        <span className="text-[15px] uppercase tracking-widest font-black mb-1">OT</span>
                        <span className="text-[15px] font-black tracking-wider tabular-nums">{selectedMatch.ot_a ?? 0}-{selectedMatch.ot_b ?? 0}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex bg-neutral-900/80 border border-neutral-800 rounded-xl p-1.5 mt-4 shadow-inner">
                  <button
                    onClick={() => setActiveRosterTab('A')}
                    className={`appearance-none outline-none focus:outline-none focus:ring-0 active:outline-none [-webkit-tap-highlight-color:transparent] flex-1 py-3 text-[15px] font-black uppercase tracking-widest rounded-lg transition-all truncate px-2 border ${
                      activeRosterTab === 'A' 
                ...
                <div className="grid grid-cols-1 gap-2.5 mt-3">
                  {activeRosterTab === 'A' ? (
                    selectedMatch.roster_a?.length > 0 ? (
                      ...
                      <p className="text-[15px] text-neutral-600 uppercase font-bold tracking-widest py-8 text-center bg-neutral-900/30 rounded-2xl border border-dashed border-neutral-900">Nessun giocatore a referto</p>
                    )
                  ) : (
      ...
      {modalLoading && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="w-12 h-12 border-4 border-neutral-800 border-t-pink-500 rounded-full animate-spin mb-4"></div>
          <span className="text-[15px] text-neutral-400 font-bold uppercase tracking-widest">Caricamento Tabellino...</span>
        </div>
      )}

      {/* BOTTOM NAVIGATION BAR */}
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-neutral-950/80 border-t border-neutral-800/60 backdrop-blur-2xl pt-3 pb-6 px-2 shadow-[0_-10px_40px_rgba(0,0,0,0.4)]">
        <div className="flex items-center justify-between w-full max-w-md mx-auto">
          ...
          <button onClick={() => setActiveTab('verocup')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'verocup' ? 'text-pink-500 scale-105' : 'text-neutral-500 hover:text-neutral-300'}`}>
            ...
            <span className="text-[9px] font-black uppercase tracking-widest">VERO CUP</span>
          </button>
          ...
          <button onClick={() => setActiveTab('contest')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'contest' ? 'text-pink-500 scale-105' : 'text-neutral-500 hover:text-neutral-300'}`}>
            ...
            <span className="text-[9px] font-black uppercase tracking-widest">Contest</span>
          </button>
          ...
          <button onClick={() => setActiveTab('stats')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'stats' ? 'text-pink-500 scale-105' : 'text-neutral-500 hover:text-neutral-300'}`}>
            ...
            <span className="text-[9px] font-black uppercase tracking-widest">TOP SCORER</span>
          </button>
